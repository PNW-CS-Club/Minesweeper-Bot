...
public class Solver {
  ...
  public Solver(int difficulty, boolean guessing, boolean debug, int width, int height, int mineCount) {
    ...
    switch (difficulty) {
      case 1: // easy
        this.gameBoard = new Board(9, 9, 10, this.boardDOM);

        break;
      case 2: // medium
        this.gameBoard = new Board(16, 16, 40, this.boardDOM);

        anchors.get(1).click();
        break;
      case 3: // hard
        this.gameBoard = new Board(30, 16, 99, this.boardDOM);

        anchors.get(2).click();
        break;
      case 4: // evil
        this.gameBoard = new Board(30, 20, 130, this.boardDOM);

        anchors.get(3).click();
        break;
      case 5: // custom
        this.gameBoard = new Board(width, height, mineCount, this.boardDOM);

        anchors.get(4).click();
        // NEED TO FILL IN TEXT FIELDS
        break;
    ...
    // make first move
    this.startCellDiv.click();

    // update Cells
    try {
      Thread.sleep(100);

      // updateCells(this.gameBoard.getCellAtIndex(y * width + x));
      boardDiv = this.driver.findElement(By.xpath("//div[@id='A43']"));
      this.boardDOM = boardDiv.findElements(By.tagName("div"));
      this.gameBoard.updateBoard(this.boardDOM);
  ...
  // if (pxColor.getRed() == 198 && pxColor.getGreen() == 198 && pxColor.getBlue()
  // == 198) {
  // this.ul_x = x;
  // break;
  // }
  ...
  // pxColor = this.bot.getPixelColor(x, height / 2);
  // if (pxColor.getRed() == 255 && pxColor.getGreen() == 255 && pxColor.getBlue()
  // == 255) {
  // this.ul_x = x;
  // break;
  // }
  ...
  // if (pxColor.getRed() == 128 && pxColor.getGreen() == 128 && pxColor.getBlue()
  // == 128) {
  // this.ul_y = y + 1;
  // break;
  // }
  ...
  // if (this.debug)
  // System.out.println("upper left corner coordinates: " + this.ul_x + ", " +
  // this.ul_y);
  ...
  // csl++;
  // if (pxColor.getRed() == 184 && pxColor.getGreen() == 184 && pxColor.getBlue()
  // == 184) {
  // break;
  // }
  // }
  ...
  // newCSL++;
  // if (!(pxColor.getRed() == 198 && pxColor.getGreen() == 198 &&
  // pxColor.getBlue() == 198))
  // break;
  // }
  ...
  // this.gameBoard.getCellAtIndex(y * this.gameBoard.getWidth() +
  // x).setCoords(xCoord, yCoord);
  ...
  // this.startCell = this.gameBoard.getCellAtIndex(y * this.gameBoard.getWidth()
  // + x);
  // }
  // }
  // }
  ...
  // * contents. Uses BFS tree/graph search algorithm to traverse the cell
  // objects.
  // *
  ...
  // if (this.debug)
  // this.bot.mouseMove(cell.getXCoord() - ((this.cellSideLength) / 2) + 2,
  // cell.getYCoord());

  // // white pixel location
  // px = this.bot.getPixelColor(cell.getXCoord() - ((this.cellSideLength) / 2) +
  // 2, cell.getYCoord());
  ...
  public void solve() {
    ...
    if (this.gameBoard.getMineCount() == 0) {
      for (int i = 0; i < this.gameBoard.getSize(); ++i) {
        if (this.gameBoard.getCellAtIndex(i).getContents() == 'U')
          this.gameBoard.getCellAtIndex(i).getDiv().click();
      }
    ...
    if (this.infiniteLoop && this.gameBoard.getUnclicked() != 0 && this.guessIfDumb) {
      ...
      // Color px = this.bot.getPixelColor(guessing.getXCoord(),
      // guessing.getYCoord());
      ...
      String[] divClass = guessing.getDiv().getAttribute("class").split(" ");
      if (divClass[divClass.length - 1].equals("hd_type11")) {
        System.out.println("Oh no! I am so dumb and clumsy... I hit a mine!");
        this.driver.quit();
        return;
      }

      // if ((px.getRed() == 103 || px.getRed() == 102) && px.getGreen() == 108 &&
      // px.getBlue() == 101) {
      // System.out.println("Oh no! I am so dumb and clumsy... I hit a mine!");
      // return;
      // }
